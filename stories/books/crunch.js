...
import { quotes, rand, themes, icons } from './helpers';
...
const raise = (extra) => {
    const toast = cinnamonSugar({
        ...
        theme: rand(['grey', 'red', 'blue', 'purple', 'orange', 'green']),
        icon: rand(icons),
        kind: 'crunch'
    });
...
export default storiesOf('Toast: crunch', module) // eslint-disable-line no-undef
    .add('bottom-left', () => (
        <div>
